...
export const DEFAULTS: Sel = {
  ...
  hide: DEFAULT_HIDE, max: null, map: null, bathy: null, bathyo: null, land: true, baseLabels: true, layers: null, view3d: false, exag: null, strip: null, ramp: null, data: true, datao: null,
};

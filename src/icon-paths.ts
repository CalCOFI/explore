// the icon paths alone (plain TS, no React): src/icons.tsx renders them, scripts/build_icons.mjs turns them into
// the brand's sprite + masks (Node imports this file directly — keep it free of JSX and of anything but @mdi/js).
import {

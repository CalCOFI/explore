...
export function MapView(props: {
  ...
  useEffect(() => { applyStyle(); }, [props.theme, props.bathy.parts.join(","), props.bathy.opacity, props.bathy.land, props.bathy.baseLabels, props.bathy.baseLabelOpacity, boundsKey]);
